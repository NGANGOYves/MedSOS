...
class EditProfileDoctorPage extends StatefulWidget {
  const EditProfileDoctorPage({super.key});

  @override
  State<EditProfileDoctorPage> createState() => _EditProfileDoctorPageState();
}

class _EditProfileDoctorPageState extends State<EditProfileDoctorPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BackRedirectWrapper(
      targetRoute: '/edit-profile-doctor',
      child: Scaffold(
        appBar: AppBar(
          leading: IconButton(
            onPressed: () => context.go('/setting-doctor'),
